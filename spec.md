...
### Project Format
You must build in in components. It is always better to put the components in a different file. Always separate the css and jsx.
...
#### 1.2.0. Document, Header, and Footerbef (10 marks)
